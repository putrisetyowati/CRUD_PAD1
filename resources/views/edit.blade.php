            ...
            <div class="col-12">
                <form action="/karyawan/{{$karyawan->id}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="no" id="exampleInputEmail1" value="{{$karyawan->no}}" required>
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Nama</label>
                        <input type="text" class="form-control" name="nama" id="xampleInputEmail1" require value="{{$karyawan->nama}}" required>
                    </div>

                    <div class="mb-3">

                        <select class="form-control" name="jenis_kelamin" id="exampleFormControlSelect1" required>
                            <option value="{{$karyawan->jenis_kelamin}}">Pilih Jenis Kelamin</option>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="status" id="exampleFormControlSelect1" required>
                            <option value="{{$karyawan->status}}">Pilih Status</option>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" class="form-control" name="ttl" id="exampleInputEmail1" required value="{{$karyawan->ttl}}">
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Alamat</label>
                        <input type="text" class="form-control" name="alamat" id="exampleInputEmail1" required value="{{$karyawan->alamat}}">
                    </div>
